...
int main(void)
{
    ...
    while(card < 0); //the number must be greater than 0
    ...
    //select the numbers that were not multiplied by 2
    ...
    //differentiate VISA, AMERICAN EXPRESS, MASTERCARD
